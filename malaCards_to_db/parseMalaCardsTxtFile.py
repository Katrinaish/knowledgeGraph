...
"""
DiseaseName,DiseaseSlug,DisplayedDiseaseName,GeneSymbol,isElite,isCancerCensus,GeneDisorderScore,SourceImplication,PubmedIds
"""
def create_tables():
    ...
    try:
        ...
        for command in commands:
            cur.execute(command)
        # insert records
        with open('/mnt/knowledgeGraphData/malaCards/malaCardsParsed.csv','rb') as csvFile:
